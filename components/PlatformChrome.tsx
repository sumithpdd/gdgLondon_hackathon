...
export function PlatformChrome({
  children,
  mainClassName = "w-full max-w-5xl mx-auto px-5 sm:px-8 py-10 sm:py-14",
  showFooter = true,
  withAuthShell = true,
}: PlatformChromeProps) {
  const body = (
    <div className="min-h-screen bg-background text-foreground bg-gradient-to-b from-background via-background to-muted/40">
      ...
      {showFooter ? (
        <footer className="border-t border-border mt-16 sm:mt-20 py-12 sm:py-14">
          <div className="container mx-auto px-5 sm:px-8 max-w-6xl flex flex-col items-center gap-8 text-center text-base text-muted-foreground">
